...
export const EditPinModal: React.FC<EditPinModalProps> = ({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError('Anı güncellenirken hata oluştu.');
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <div className="modal-overlay">
      <div className="modal-content">
        ...
        <h2 className="panel-title" style={{ marginBottom: '1.5rem', fontSize: '1.5rem' }}>Anıyı Düzenle</h2>
